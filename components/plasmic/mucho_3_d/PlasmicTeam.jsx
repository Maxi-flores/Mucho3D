...
import sty from "./PlasmicTeam.module.css"; // plasmic-import: GgHk-pIb3D7y/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img___2FUen)}
            displayHeight={"auto"}
          ...
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__zb6Ue)}
            displayHeight={"auto"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            displayMinHeight={"0"}
          ...
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__bwlg4)}
            displayHeight={"auto"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            displayMinHeight={"0"}
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox___2V6Jh)}>
              <div
                data-plasmic-name={"columns"}
                data-plasmic-override={overrides.columns}
                className={classNames(projectcss.all, sty.columns)}
              >
                <div className={classNames(projectcss.all, sty.column__wnxyS)}>
                  <PriceCard
                    borders={["flatLeft"]}
                    className={classNames(
                      "__wab_instance",
                      sty.priceCard__p5Ulx
                    )}
                  />
                </div>
                <div className={classNames(projectcss.all, sty.column__srcGf)}>
                  <PriceCard
                    borders={["flatCenter"]}
                    className={classNames(
                      "__wab_instance",
                      sty.priceCard__dwJXy
                    )}
                  />

                  <div
                    className={classNames(projectcss.all, sty.freeBox___0D1Ai)}
                  >
                    <div
                ...
                <div className={classNames(projectcss.all, sty.column__loUqn)}>
                  <PriceCard
                    borders={["flatRight"]}
                    className={classNames(
                      "__wab_instance",
                      sty.priceCard__ij6V0
                    )}
                  />
                </div>
              </div>
