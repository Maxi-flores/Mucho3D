...
import sty from "./PlasmicBlog.module.css"; // plasmic-import: pkwjA8Ed5w0M/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__iNEd)}
            displayHeight={"auto"}
          ...
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__q3Yyy)}
            displayHeight={"auto"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            displayMinHeight={"0"}
          ...
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__gbPgt)}
            displayHeight={"auto"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            displayMinHeight={"0"}
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__sn5Hm)}>
              <div
                data-plasmic-name={"columns"}
                data-plasmic-override={overrides.columns}
                className={classNames(projectcss.all, sty.columns)}
              >
                <div className={classNames(projectcss.all, sty.column__mJvw8)}>
                  <PriceCard
                    borders={["flatLeft"]}
                    className={classNames(
                      "__wab_instance",
                      sty.priceCard__ldHt0
                    )}
                  />
                </div>
                <div className={classNames(projectcss.all, sty.column__v351U)}>
                  <PriceCard
                    borders={["flatCenter"]}
                    className={classNames(
                      "__wab_instance",
                      sty.priceCard___863Pz
                    )}
                  />

                  <div
                    className={classNames(projectcss.all, sty.freeBox__uo1U8)}
                  >
                    <div
                ...
                <div className={classNames(projectcss.all, sty.column__fKW)}>
                  <PriceCard
                    borders={["flatRight"]}
                    className={classNames(
                      "__wab_instance",
                      sty.priceCard___3445R
                    )}
                  />
                </div>
              </div>
